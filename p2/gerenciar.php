...
if(isset($_POST['submitP']))
{
    ...
    $valorCompeltoB = $valor_unit * $quantC;
    $valorCompeltoS = $valor_unitS * $quantSalgC;
    $valorCompeltoR = $valor_unitR * $quantRefriC;
    $valorTotal = $valorCompeltoB + $valorCompeltoR + $valorCompeltoS;
    //print_r($_POST['valorC']);

    $result = mysqli_query($conexao, "CALL inserir_produto  ('$idcliente','$boloC','$salgadoC','$refriC','$quantC','$quantSalgC','$quantRefriC','$valor_unit','$valor_unitS','$valor_unitR','$valorCompeltoB','$valorCompeltoS','$valorCompeltoR','$valorTotal')");
}
?>
     ...
     <tr>
      ...
      <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        <a href='consultaCompleta.php?idCliente=$user_data[idCliente]' title='delete-pedido'>Consulta Completa</a> 
                        </td>";
                        echo "</tr>";
